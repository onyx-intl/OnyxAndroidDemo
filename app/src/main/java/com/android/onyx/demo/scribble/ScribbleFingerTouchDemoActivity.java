...
import com.onyx.android.demo.databinding.ActivityFingerScribbleDemoBinding;
...
public class ScribbleFingerTouchDemoActivity extends AppCompatActivity {
    ...
    private ActivityFingerScribbleDemoBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_finger_scribble_demo);
    ...
    private void initSurfaceView() {
        ...
        getHostView().addOnLayoutChangeListener(new View.OnLayoutChangeListener() {
            ...
            public void onLayoutChange(View v, int left, int top, int right, int bottom, int oldLeft, int oldTop, int
                ...
                exclude.add(getRelativeRect(getHostView(), binding.rbMarker));
